...
/// <summary>
/// OData controller that exposes client project risk area master data.
/// </summary>
/// <param name="logger">The logger used for structured logging within this controller.</param>
/// <param name="clientProjectRiskAreaBusiness">
/// The business service that provides access to risk area metadata.
/// </param>
/// <remarks>
...
/// </remarks>
[Authorize]
public class ClientProjectRiskAreaController(
    ILogger<ClientProjectRiskAreaController> logger,
    IClientProjectRiskAreaBusiness clientProjectRiskAreaBusiness) : ODataController
{
    /// <summary>
    /// A constant used to prefix log messages with the controller name.
    /// </summary>
    private const string ClassName = nameof(ClientProjectRiskAreaController);

    /// <summary>
    /// Retrieves all available risk areas.
    /// </summary>
    /// <returns>
    /// An <see cref="IActionResult"/> containing the queryable collection of risk areas.
    ...
    public async Task<IActionResult> GetAsync()
    {
        ...
        try
        {
            ...
            var result = await clientProjectRiskAreaBusiness.GetAsync();
