...
/// <summary>
/// Repository implementation for managing <see cref="ClientProjectDepartment"/> metadata.
/// </summary>
/// <remarks>
...
/// <seealso cref="GenericRepository{DefaultContext, ClientProjectDepartment}"/>
/// <seealso cref="IClientProjectDepartmentRepository"/>
/// <seealso cref="DefaultContext.ProjectDepartments"/>
public class ClientProjectDepartmentRepository(DefaultContext context)
    : GenericRepository<DefaultContext, ClientProjectDepartment>(context),
        IClientProjectDepartmentRepository
{
}