...
/// <summary>
/// Integration-style tests for <see cref="KonaAI.Master.API.Controllers.Tenant.UserMetaData.ClientProjectRiskAreaController"/>.
/// Covers:
/// - GET list (200) for read-only metadata controller
/// - GET by RowId (200 or 404)
/// - Error handling (500) for server errors
/// </summary>
public class ClientProjectRiskAreaControllerTests
{
    // Overview:
    // - Exercises ClientProjectRiskAreaController actions with mocked business dependencies.
    ...
    private static ClientProjectRiskAreaController CreateController(
        out Mock<IClientProjectRiskAreaBusiness> business)
    {
        var logger = new Mock<ILogger<ClientProjectRiskAreaController>>();
        business = new Mock<IClientProjectRiskAreaBusiness>(MockBehavior.Strict);
        return new ClientProjectRiskAreaController(logger.Object, business.Object);
    }
