...
public class CountryControllerUnitTests
{
    ...
    public async Task GetAsync_Returns200_WithData()
    {
        var data = new List<MetaDataViewModel>
        {
            ...
            new() { RowId = Guid.NewGuid(), Name = "USA", Description = "US", OrderBy = 2 }
        }.AsQueryable();
    ...
    public async Task GetByRowIdAsync_Found_Returns200()
    {
        ...
        var data = new List<MetaDataViewModel>
        {
            new() { RowId = id, Name = "India", Description = "IN", OrderBy = 1 }
        }.AsQueryable();
    ...
    {
        var attr = typeof(CountryController).GetCustomAttribute<AuthorizeAttribute>(inherit: true);
        Assert.NotNull(attr);
    }
    ...
    {
        var mi = typeof(CountryController).GetMethod(nameof(CountryController.GetAsync));
        Assert.NotNull(mi);
        var classAttr = typeof(CountryController).GetCustomAttribute<AuthorizeAttribute>(inherit: true);
